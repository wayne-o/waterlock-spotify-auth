...
spotifyAuth. _getCredential = function(credentialKey) {
    ...
    if (!_credentials) {
      ...
      return this.config[credentialKey];
    }
};
...
spotifyAuth.init = function(clientId, clientSecret, redirectURL, config, allow, credentials){
...
spotifyAuth.getClientId = function() {
	return this._getCredential('clientId');
};

spotifyAuth.getClientSecret = function() {
	return this._getCredential('clientSecret');
};

spotifyAuth.getRedirectURI = function() {
